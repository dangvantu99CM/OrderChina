			...
			<div class="col-12" style="padding-bottom:120px">
					<form id = "form_edit" action="{!! URL::route('admin.user.edit', $user->id) !!}" method="POST" enctype="multipart/form-data" >
						...
						<div class="form-group">		
							...
							<input  class = "form-control input" id = "user_code" type = "text" name = "us_code" autofocus="autofocus"  value="{!! $user->us_code !!}" placeholder = "Mã người dùng"></input>
						</div>	
						...
						<div class="form-group">		
							...
							<input  class = "form-control input" id = "phoneNumber" type = "text" name = "phoneNumber" autofocus="autofocus"  value="{!! $user->us_phone_number !!}" placeholder = "Số điện thoại người dùng"></input>
						</div>	
						...
						<div class="form-group">
							...
							<select style = "width: 50%; margin-left: 27px;height: 30px;" name = "us_quan">
							  <option value=""></option>
							</select>
						</div>	
						...
						<div class="form-group">
							...
							<select style = "width: 50%; margin-left: 33px;height: 30px;" name = "us_xaPhuong">
							  <option value=""></option>
							</select>
						</div>	
						...
						<div class="form-group">
							...
							<img id = "avar" name = "path_db"  width="100px" height="30%" alt="avatar" src="{{asset($user->us_avartar)}}" accept="image/*"/>
							<input style="margin-top: 5px;" type = "file"  name = "avatar" value="{{asset($user->us_avartar)}}"  onchange="readURL(this);"></input>
							<script>
